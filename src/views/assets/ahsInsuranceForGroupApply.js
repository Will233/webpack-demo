/* 投保人证件类型选择   */
// import queryGroupAhsIndustry from '../mock/queryGroupAhsIndustry.json';
$(function(){
	...
	$.ajax({
		...
		url: '../mock/queryGroupAhsIndustry.json',
		async:false,
		dataType: 'json',
		...
		error:function(res){
			console.log('error');
			industryData=queryGroupAhsIndustry.industryList;
		}
	});
	...
	window.selectIndustry={    			
		createHTML:function(){
			...
			selectList.forEach(function(value,i){
				...
				'<span>'+value[1]+'</span>',
				'<img class="iconRight" src="../assets/icon_right.png" >',
				'</p>'].join("");
			});
